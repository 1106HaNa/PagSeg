...
class VisualizationDemo(object):
    ...
    def run_on_image(self, image):
        ...
        #####
        file = open('/home/liuchanghe/lmy/PAG-Seg/datasets/pc459.json','r',encoding='utf-8')
        data = json.load(file)
        ...
        target_class = category_to_id["chair"]   #
        ...
        plt.imshow(class_prob, cmap='jet', alpha=0.5)  # 叠加热力图
        plt.axis('off')  # 关闭坐标轴
        plt.savefig('/home/liuchanghe/lmy/PAG-Seg/picture/hot/model2/ADE_val_00000047_chair_hot.png')
        #####
